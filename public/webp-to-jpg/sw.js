...
const PRECACHE_URLS = [
  '/webp-to-jpg/',
  '/webp-to-jpg/manifest.json',
  '/webp-to-jpg/icon-192.png',
  '/webp-to-jpg/icon-512.png',
];
...
function isStaticAsset(pathname) {
  ...
  return staticExtensions.some(ext => pathname.endsWith(ext)) || pathname === '/webp-to-jpg/manifest.json';
}
