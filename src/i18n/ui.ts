...
export const ui = {
  en: {
    ...
    uploadSubtitle: 'Choose WebP image files.',
    dropClick: 'Click to choose files',
    dropOr: 'or drop files anywhere on the page',
    dropSupported: 'Supported: WebP (or paste to add)',
    ...
    errUnsupported:
      'Unsupported file type ({name}). Only WebP files can be converted.',
    ...
    dzDropSub: 'WebP files can be converted',
  ...
  ja: {
    ...
    uploadSubtitle: 'WebP 画像ファイルを選んでください。',
    dropClick: 'クリックして選択',
    dropOr: 'またはページ上にドロップ',
    dropSupported: '対応形式: WebP（貼り付けでも追加できます）',
    settingsButton: '設定',
    ...
    errUnsupported:
      '対応していない形式です（{name}）。WebP ファイルのみ変換できます。',
  ...
  zh: {
    // ConversionManager
    uploadHeading: '选择文件',
    uploadSubtitle: '请选择 WebP 图片文件。',
    dropClick: '点击选择文件',
    dropOr: '或把文件拖到页面任意位置',
    dropSupported: '支持格式：WebP（也可粘贴添加）',
    settingsButton: '设置',
    ...
    errUnsupported: '不支持的文件类型（{name}）。只能转换 WebP 文件。',
  ...
  de: {
    ...
    uploadSubtitle: 'Wähle WebP-Bilddateien aus.',
    dropClick: 'Zum Auswählen klicken',
    dropOr: 'oder Dateien irgendwo auf die Seite ziehen',
    dropSupported: 'Unterstützt: WebP (oder zum Hinzufügen einfügen)',
    ...
    errUnsupported:
      'Nicht unterstützter Dateityp ({name}). Nur WebP-Dateien können umgewandelt werden.',
    ...
    dzDropSub: 'WebP-Dateien können umgewandelt werden',
  ...
  es: {
    ...
    errUnsupported: 'Tipo de archivo no compatible ({name}). Solo se pueden convertir archivos WebP.',
    ...
    dzDropSub: 'Se pueden convertir archivos WebP',
