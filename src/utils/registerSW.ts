...
export async function registerServiceWorker(): Promise<ServiceWorkerRegistration | null> {
  ...
  try {
    // Service Workerを登録（/webp-to-jpg/sw.js, scope=/webp-to-jpg/）。
    // scope がツールの全 locale ページ（/webp-to-jpg/, /webp-to-jpg/ja/ …）を被覆する。
    const registration = await navigator.serviceWorker.register('/webp-to-jpg/sw.js', {
      scope: '/webp-to-jpg/',
    });
